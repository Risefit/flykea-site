...
<a class="nav-agentbtn" href="/agents/">Agent Login</a>
...
<div id="pt-gates">
  ...
  <div class="pt-gate pt-narrow" data-gate="apply" hidden>
    <div class="pt-card">
      ...
      <form id="pt-apply-form">
        ...
        <p id="pt-apply-err" hidden style="background:#f7e0e0;color:#8d2b2b;padding:.7rem .9rem;border-radius:6px;font-size:.85rem;margin-bottom:.9rem"></p>
  ...
  <div class="pt-gate pt-narrow" data-gate="confirm" hidden>
    <div class="pt-card" style="text-align:center">
      <h2 style="font-size:1.3rem">Confirm your email</h2>
      <p class="pt-lead" style="margin:1rem auto">We&rsquo;ve sent a confirmation link to
      <b id="pt-confirm-email"></b>. Click it to activate your login, then sign in here.
      Your application then goes to our reservations team for approval.</p>
      <p style="font-size:.85rem;color:var(--slate)">Nothing arrived? Check spam, or email
      <a href="mailto:reservations@flykea.com" style="color:var(--green-ink)">reservations@flykea.com</a>.</p>
      <button class="pt-btn ghost" data-gateswap="auth" style="margin-top:1.2rem">Go to sign in</button>
    </div>
  </div>
...
<div id="pt-app" hidden>
  <div class="pt-bar">
    ...
    <button class="pt-tab pt-staff-only" data-go="queue" hidden>Bookings queue</button>
  ...
  <section class="pt-view pt-wrap" data-view="quote">
    ...
    <p class="pt-lead">Build a single hop or a multi-airfield itinerary. Prices show the rack rate your client pays,
    your agency net, and your margin. Charter includes positioning back to base.</p>
    <div class="pt-grid">
      <div class="pt-card">
        <div id="pt-legs"></div>
        <datalist id="pt-ports"></datalist>
        <div class="pt-legbtns">
          <button class="pt-mini" id="pt-swap" type="button">&#8645; Swap</button>
          <button class="pt-mini ok" id="pt-addleg" type="button">+ Add leg</button>
        </div>
        <div class="pt-note-help">For a lodge, camp or any point that is not a listed airfield &mdash; typically a
          helicopter landing &mdash; either pick the nearest Ugandan town, drop a pin on the map, or paste GPS coordinates.
          The client must obtain landowner permission in advance, and no dust landings are permitted.</div>
        <div class="pt-fld"><label>Ugandan town (fills coordinates)</label>
        ...
        <label class="pt-check"><input type="checkbox" id="pt-daystop"> Aircraft waits for 2+ hours (day stop)</label>
        <div class="pt-fld"><label>Night stops (aircraft stays overnight)</label>
          <input id="pt-nights" type="number" min="0" max="14" value="0"></div>
        <button class="pt-btn" id="pt-calc" type="button">Calculate</button>
      </div>

      <div>
        <div class="pt-card pt-res" id="pt-result" hidden>
          <h3 id="pt-r-route" style="font-size:1.1rem;margin-bottom:.35rem"></h3>
          <span class="pt-pill" id="pt-r-method"></span>
          <p style="color:var(--slate);font-size:.9rem;margin:.6rem 0 1rem"><b id="pt-r-ac"></b></p>
          <div class="pt-leglist" id="pt-r-legs"></div>
          <div class="pt-metrics">
            <div class="pt-m"><div class="k">Total distance</div><div class="v" id="pt-r-dist"></div></div>
          ...
          <p class="pt-confid">Range <span id="pt-r-band"></span> &middot; excludes landing, handling &amp; route fees
          &middot; net and margin are confidential to your agency</p>
          <div id="pt-r-nightwarn" hidden class="pt-warn">Night-stop charges are not yet loaded for this aircraft &mdash;
          reservations will confirm the overnight cost.</div>
          <div id="pt-r-intl" hidden class="pt-warn">International routing &mdash; permits and fees vary.
          Send the request and we&rsquo;ll confirm a firm price fast.</div>
          <div class="pt-actions">
            <button class="pt-btn" id="pt-clientquote" type="button">Client quote PDF</button>
            <a class="pt-btn ghost" href="#" onclick="return false" style="pointer-events:none;opacity:.35">Saved to My quotes</a>
          </div>
          <p style="font-size:.82rem;color:var(--slate);margin-top:.9rem">This quote is saved automatically.
          Go to <b>My quotes</b> to book it or tell us why you didn&rsquo;t.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="pt-view pt-wrap" data-view="quotes" hidden>
    <h2>My quotes</h2>
    <p class="pt-lead">Every quote you run is saved here. Book it, or tell us what stopped it &mdash;
    that feedback is what helps us sharpen pricing and win you more business.</p>
    <div class="pt-tablewrap"><table class="pt-t" id="tbl-quotes"><thead><tr>
      ...
      <th>Client quote</th><th>Book</th><th>Decline</th>
    </tr></thead><tbody id="pt-quotes-body"></tbody></table></div>

    <div class="pt-card pt-whybox" id="pt-whybox" hidden style="margin-top:1.6rem;max-width:560px">
      <h3 style="font-size:1.05rem;margin-bottom:.2rem">What stopped this one?</h3>
      <p style="color:var(--slate);font-size:.88rem;margin-bottom:1rem" id="pt-why-label"></p>
      <input type="hidden" id="pt-why-quote">
      <div class="pt-fld"><label>Reason</label><select id="pt-why-reason"></select></div>
      ...
      <div style="display:flex;gap:.6rem">
        ...
        <button class="pt-mini" id="pt-why-cancel" type="button">Cancel</button>
      </div>
    </div>
  </section>

  <!-- ---- BOOK (reached from My quotes) ---- -->
  <section class="pt-view pt-wrap" data-view="book" hidden>
    <h2>Request this charter</h2>
    <p class="pt-lead">Our reservations desk will confirm availability and a firm price.</p>
    <div class="pt-card" style="max-width:620px">
      <div class="pt-booksum" id="pt-book-summary"></div>
      <form id="pt-book-form">
        ...
        <button class="pt-btn" type="submit">Submit booking request</button>
      </form>
      <div id="pt-booked" hidden style="margin-top:1rem;background:var(--tint);padding:1rem;border-radius:8px;font-size:.9rem">
        Request sent &mdash; reference <b id="pt-booked-ref"></b>. It now appears in your <b>Bookings</b> tab, and our
        reservations team has been notified by email.</div>
    </div>
  </section>
  ...
  <section class="pt-view pt-wrap" data-view="bookings" hidden>
    ...
    <div class="pt-tablewrap"><table class="pt-t"><thead><tr>
      <th>Reference</th><th>Raised</th><th>Client ref</th><th>Value</th><th>Status</th><th>Confirmation</th><th>Your commission</th>
  ...
  <section class="pt-view pt-wrap" data-view="terms" hidden>
    ...
    <div class="pt-card pt-terms">
      <h3>What the charter price includes</h3>
      <ul>
        <li>Landing fees at airports on the quoted routing</li>
        <li>ATNS / air navigation fees</li>
        <li>Passenger taxes at airports</li>
        <li>Pilot fees and per diem</li>
        <li>Passenger legal liability and insurance</li>
        <li>Animal clearance where required</li>
        <li>Transport for crew</li>
        <li>Fuel at airports</li>
      </ul>

      <h3>What is excluded</h3>
      <ul>
        <li>Pilot rest room, accommodation, meals and transport where the aircraft stays out</li>
        <li>In-flight catering</li>
        <li>Passenger land transfers</li>
        <li>Agent commission</li>
        <li>Ad-hoc landing fees and off-site landing costs</li>
        <li>Local authority fees and clearances</li>
      </ul>

      <h3>Quotations and pricing</h3>
      <p>Quotations are valid for <b>30 days</b> from issue; quotes issued further in advance are indicative only and
      subject to revision. Prices are aircraft specific and strictly subject to aircraft serviceability and availability.
      VAT at 18% is reflected separately where applicable. Kampala Executive Aviation Ltd is withholding-tax exempt, so
      quoted prices are fully payable. Rates are subject to fuel price fluctuation, and any fuel surcharge above the
      amount provided for will be billed in addition.</p>

      <h3>Flight time</h3>
      <p>Quoted flight time is an estimate and may change due to weather, diversion, air traffic control and other
      operational factors. <b>All flying time exceeding the quoted time is charged additionally.</b> Costs arising from
      passenger-induced delays or itinerary changes, and from delay or diversion beyond KEA&rsquo;s control, become payable
      in addition to the quoted price.</p>

      <h3>Passengers and baggage</h3>
      <p>Passenger names must be provided before the flight for legal and insurance purposes. On helicopter flights only
      <b>soft luggage, 5&nbsp;kg per passenger</b>, is permitted. All passenger and baggage weights must be declared
      accurately; KEA may offload where weight and balance, performance or weather require it. The pilot in command has
      final authority on every flight.</p>

      <h3>Helicopter and off-airfield landings</h3>
      <ul>
        <li>The client must obtain GPS coordinates and landowner permission in advance</li>
        <li><b>No dust landings are permitted</b></li>
        <li>Off-site landing costs are excluded from the quote</li>
        <li>Pilot day room, accommodation, transport and meals are for the client&rsquo;s account</li>
      </ul>

      <h3>Permits</h3>
      <p>Every quote is subject to landing and overflight permission being granted by all relevant authorities prior to
      the flight. Permits are only applied for once written confirmation has been received. KEA will do all in its power
      to secure the necessary permits and slots but cannot be held liable where they are refused or delayed.</p>

      <h3>Confirmation and payment</h3>
      <p>No booking is confirmed until KEA receives written confirmation. Full payment is required before departure
      unless other arrangements have been agreed in writing. Payment may be made by bank-guaranteed cheque, direct bank
      transfer, direct deposit or credit card; <b>card payments attract 5% bank charges</b>. Banking details are provided
      on the invoice &mdash; always verify them with our reservations team by phone before transferring funds.</p>

      <h3>Cancellation</h3>
      <ul>
        <li><b>20%</b> of the quoted amount on confirmation and up to 48 hours in advance</li>
        <li><b>50%</b> of the quoted amount within 24 hours of departure</li>
        <li><b>100%</b> of the quoted amount on the scheduled day of departure</li>
      </ul>

      <h3>Agency obligations</h3>
      <p>Agency net rates and margins are confidential and must not be disclosed to your clients or any third party.
      Agents are responsible for the accuracy of passenger information, for ensuring passengers hold valid travel
      documentation, and for passing KEA&rsquo;s safety briefings and conditions to their clients.</p>

      <h3>Governing law</h3>
      <p>These terms are governed by and construed in accordance with the laws of the Republic of Uganda, and disputes
      are determined in the Ugandan courts of applicable jurisdiction. The full standard terms and conditions of charter
      form part of every quotation issued.</p>

      <p style="margin-top:1.6rem;font-size:.85rem"><b>Kampala Executive Aviation Ltd</b><br>
      Ugandan CAA AOC 097 &middot; Company Registration 80010003208761 &middot; TIN 1000434354<br>
      Gate 1, Kajjansi Airfield, Kampala, Uganda &middot; +256 776 333 114 &middot; reservations@flykea.com</p>
    </div>
  </section>
  ...
  <section class="pt-view pt-wrap" data-view="profile" hidden>
    ...
    <div class="pt-card" style="max-width:640px">
      <div class="pt-note-help">These details were taken from your trade account application and are used on the
        <b>client quotations</b> you generate &mdash; edit anything that has changed and save.</div>
      <form id="pt-profile-form">
        <div class="pt-fld"><label>Agency name</label><input id="pf-agency" required></div>
        <div class="pt-fld"><label>Account email (contact us to change)</label><input id="pf-email" readonly></div>
        <div class="pt-2">
        ...
        <div class="pt-note-help">Your logo appears at the top of every <b>client quotation PDF</b> you generate from the
          Quote tab or from My quotes, alongside your agency name, address and contact details &mdash; so the document your
          client receives is branded as yours. KEA&rsquo;s net rates and your margin never appear on it. A landscape PNG or
          JPG with a transparent or white background works best.</div>
  ...
  <section class="pt-view pt-wrap" data-view="reports" hidden>
    ...
    <div class="pt-sec"><h3>Aircraft popularity
      <button class="pt-mini" data-csv="rp-aircraft-t">Export CSV</button></h3>
      <div class="pt-tablewrap"><table class="pt-t" id="rp-aircraft-t"><thead><tr>
        <th>Aircraft</th><th>Times quoted</th><th>Requested</th><th>Conversion</th><th>Avg pax</th><th>Avg rack</th>
      </tr></thead><tbody id="rp-aircraft"></tbody></table></div></div>
  ...
  <section class="pt-view pt-wrap" data-view="queue" hidden>
    <h2>Bookings queue</h2>
    <p class="pt-lead">Live booking requests from trade agents. Accept a booking to confirm it to the agent, then send
    them the confirmation email. Declining requires a reason, which feeds the loss reports.</p>
    <p style="font-family:var(--mono);font-size:.72rem;color:var(--green-ink);margin-bottom:1rem" id="pt-queue-count"></p>
    <div class="pt-tablewrap"><table class="pt-t"><thead><tr>
      <th>Reference</th><th>Agency</th><th>Routing</th><th>Value</th><th>Client ref</th><th>Status</th><th>Action</th>
    </tr></thead><tbody id="pt-queue-body"></tbody></table></div>
  </section>
