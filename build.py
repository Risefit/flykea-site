...
<div id="pt-app" hidden>
  ...
  <section class="pt-view pt-wrap" data-view="quote">
    ...
    <div class="pt-grid">
      <div class="pt-card">
        ...
        <div class="pt-fld" style="margin-top:1rem"><label>Ugandan town (fills coordinates)</label>
  ...
  <section class="pt-view pt-wrap" data-view="bookings" hidden>
    ...
    <div class="pt-tablewrap"><table class="pt-t"><thead><tr>
      <th>Reference</th><th>Raised</th><th>Client ref</th><th>Value</th><th>Status</th><th>Confirmation</th>
