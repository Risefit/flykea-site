...
SERVICES = [
{
 ...
 "desc":"Oil & gas charter flights in Uganda — crew rotation, cargo and medevac for energy operators from Kajjansi Airstrip, Kampala. Call KEA +256 776 333 114.",
 ...
 "lead":"KEA provides <b>oil and gas charter flights in Uganda</b> and across the region from our base at <b>Kajjansi Airstrip, Kampala</b> — moving crews, equipment and time-critical cargo to fields, exploration camps and remote sites.",
 "secs":[
...
},
{
 ...
 "lead":"KEA flies <b>medical evacuation flights in Uganda</b> and across East Africa, 24/7, from <b>Kajjansi Airstrip, Kampala</b> — rapid fixed-wing and helicopter air ambulance for patients, casualties and remote-site emergencies.",
 "secs":[
...
},
{
 ...
 "desc":"Helicopter charter in Kampala, Uganda — hire a Bell 412 or 206 for charter, survey and external load from Kajjansi Airstrip. Call KEA +256 776 333 114.",
 ...
 "lead":"Charter a helicopter in Kampala with KEA from <b>Kajjansi Airstrip</b>. <b>Helicopter charter in Kampala, Uganda</b> for passenger transfers, survey, external-load and remote-site access — Bell 412, Bell 206 and heavy-lift options.",
 "secs":[
 ...
 "faqs":[
  ...
  ("Where do helicopter charters depart from?","Our base is Kajjansi Airstrip, Kampala, with repositioning across Uganda and the region."),
 ],
...
},
{
 ...
 "lead":"KEA is a trusted partner for <b>NGO charter flights in Uganda</b> and <b>humanitarian air services</b> across the region, flown from <b>Kajjansi Airstrip, Kampala</b> — moving relief teams, supplies and patients into hard-to-reach locations.",
 "secs":[
...
},
{
 ...
 "lead":"KEA flies <b>aerial survey in Uganda and East Africa</b> from <b>Kajjansi Airstrip, Kampala</b> — airborne geophysical surveys, mapping and wildlife census with stable, sensor-equipped platforms including the DA42 Guardian.",
 "secs":[
...
},
{
 ...
 "hero":"2021/08/Mi8-Helicopter-Kajjansi-KEA-1.jpg","og":"2021/08/Mi8-Helicopter-Kajjansi-KEA-1.jpg",
 "lead":"KEA delivers <b>remote site aviation in Uganda and across Africa</b> from <b>Kajjansi Airstrip, Kampala</b> — connecting bush airstrips, camps and project sites that scheduled airlines never reach.",
 "secs":[
...
},
{
 ...
 "lead":"KEA offers <b>wet lease, dry lease and ACMI aircraft in Uganda</b> from <b>Kajjansi Airstrip, Kampala</b> — putting CAA-licensed capacity and crews to work for operators, governments and projects across Africa.",
 "secs":[
...
},
{
 ...
 "hero":"2019/01/Aerial-Survey-KEA.jpg","og":"2019/01/Aerial-Survey-KEA.jpg",
 "lead":"KEA flies <b>pipeline patrol aviation in Uganda</b> from <b>Kajjansi Airstrip, Kampala</b> — routine aerial inspection of pipelines, powerlines and right-of-way corridors for energy and infrastructure operators.",
 "secs":[
...
},
{
 ...
 "hero":"2019/01/Medevac-KEA.jpg","og":"2019/01/Medevac-KEA.jpg",
 "lead":"KEA provides <b>search and rescue helicopter</b> and casualty-evacuation support in Uganda and East Africa from <b>Kajjansi Airstrip, Kampala</b> — rapid rotary-wing response for projects and operations in remote terrain.",
 "secs":[
...
},
{
 ...
 "lead":"KEA flies <b>underslung load helicopter operations in Uganda</b> from <b>Kajjansi Airstrip, Kampala</b> — precision external-load lifts for construction, energy, telecoms and remote projects.",
 "secs":[
...
},
{
 ...
 "lead":"KEA provides <b>disaster response aviation in Uganda</b> and the region from <b>Kajjansi Airstrip, Kampala</b> — rapid airlift of responders and relief cargo, aerial assessment and casualty evacuation when time matters.",
 "secs":[
...
},
{
 ...
 "desc":"Same-day private charter flights from Kampala across Uganda and Africa — fixed wing and helicopter from Kajjansi Airstrip. Call KEA +256 776 333 114.",
 ...
 "lead":"Need to fly today? KEA arranges <b>same-day charter flights from Kampala</b> at <b>Kajjansi Airstrip</b> — private fixed-wing and helicopter charter across Uganda, East Africa and beyond, on your schedule.",
 "secs":[
 ...
 "faqs":[
  ...
  ("Where do charters depart from?","Kajjansi Airstrip, Kampala, with pickups arranged regionally."),
...
},
{
 ...
 "lead":"KEA flies <b>cargo charter flights across Uganda and Africa</b> from <b>Kajjansi Airstrip, Kampala</b> — time-critical, outsized and project cargo delivered to main airports and remote strips alike.",
 "secs":[
...
},
{
 ...
 "desc":"Discreet VIP and executive charter from Kampala for corporate and government travel across Africa, from Kajjansi Airstrip. Call KEA +256 776 333 114.",
 ...
 "lead":"KEA flies <b>VIP and corporate charter from Kampala</b> at <b>Kajjansi Airstrip</b> — discreet, comfortable executive travel for business and government across Uganda and Africa.",
 "secs":[
...
},
{
 ...
 "desc":"Private jet and executive charter from Kampala across Africa, arranged by a CAA-licensed operator at Kajjansi Airstrip. Call KEA +256 776 333 114.",
 "h1":"Private Jet & Executive Charter in Uganda","eyebrow":"VIP / Corporate","stype":"Private jet charter",
 "hero":"2019/02/Fleet-PC12.jpg","og":"2019/02/Fleet-PC12.jpg",
 "lead":"KEA arranges <b>private jet charter in Uganda</b> and <b>Kampala</b> from <b>Kajjansi Airstrip</b> — executive jet and turboprop travel across Africa, planned and flown to the standards of a CAA-licensed operator.",
 "secs":[
...
},
{
 ...
 "desc":"Private charter from Kampala into the DRC — passengers and cargo to Kinshasa, Goma and remote sites from Kajjansi Airstrip. Call KEA +256 776 333 114.",
 "h1":"Charter Flights to DRC from Kampala","eyebrow":"Cross-border","stype":"Cross-border charter to DRC",
 "hero":"2021/03/PHOTO-2021-02-23-13-56-15.jpg","og":"2021/03/PHOTO-2021-02-23-13-56-15.jpg",
 "lead":"KEA flies <b>charter flights to the DRC from Kampala</b> and <b>Kajjansi Airstrip</b> — passengers and cargo to Bunia, Goma, Kinshasa and remote eastern-DRC sites, with deep regional experience.",
 "secs":[
...
},
{
 ...
 "hero":"2021/08/Mi8-Helicopter-Kajjansi-KEA-1.jpg","og":"2021/08/Mi8-Helicopter-Kajjansi-KEA-1.jpg",
 "lead":"KEA flies <b>charter flights to South Sudan from Uganda</b>, departing <b>Kajjansi Airstrip, Kampala</b> — Juba and beyond for NGO, energy and corporate clients, with a local AOC for in-country operations.",
 "secs":[
...
},
{
 ...
 "desc":"CAA-approved aircraft maintenance, MRO and hangarage near Entebbe and Kampala at Kajjansi Airstrip for fixed and rotary wing. Call KEA +256 776 333 114.",
 ...
 "lead":"KEA's Approved Maintenance Organisation delivers <b>aircraft MRO and maintenance near Entebbe</b> at <b>Kajjansi Airstrip, Kampala</b> — line and base maintenance, plus hangarage, for fixed and rotary-wing aircraft.",
 "secs":[
...
},
{
 ...
 "lead":"KEA flies <b>CAA-certified UAV operations in Uganda</b> from <b>Kajjansi Airstrip, Kampala</b> — drone survey, LiDAR and orthophoto mapping and asset inspection with the DJI Matrice 400 RTK, under our Ugandan CAA UAV Operating Certificate (UOC).",
 "secs":[
